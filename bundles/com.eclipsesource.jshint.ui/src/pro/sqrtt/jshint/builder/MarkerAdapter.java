...
public class MarkerAdapter {
  ...
  private static final String TYPE_PROBLEM = "pro.sqrtt.jshint.problemmarker";
  private static final String TYPE_PROBLEM_OLD = "pro.sqrtt.jshint.problemmarker";
  ...
  public void createInfo( int line, int start, int end, String message ) throws CoreException {
	    createMarker( line, start, end, message, IMarker.SEVERITY_INFO );
  }
